...
do
	...
	echo azcopy copy https://academicgraph2.blob.core.windows.net/mag-$VERSION/mag/$FILE graph/$VERSION/$FILE --recursive
	azcopy copy https://academicgraph2.blob.core.windows.net/mag-$VERSION/mag/$FILE graph/$VERSION/$FILE --recursive
    fi
done
...
do
	...
	echo azcopy copy https://academicgraph2.blob.core.windows.net/mag-$VERSION/advanced/$FILE graph/$VERSION/$FILE --recursive
	azcopy copy https://academicgraph2.blob.core.windows.net/mag-$VERSION/advanced/$FILE graph/$VERSION/$FILE --recursive
    fi
done
