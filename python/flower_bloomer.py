...
def getPreFlowerData(id_2_paper_id, unselected_id_2_paper_id, ent_type, cbfunc=None): # id_2_paper_id should be a dict eid: [pid] including all papers regardless if they were deselected
