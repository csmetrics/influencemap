...
def construct_paper_info():
    ...
    cur.execute('CREATE TABLE paper_info AS SELECT a.paper_id, auth_id, auth_count, conf_id, affi_id FROM papers a INNER JOIN paa_count b ON a.paper_id = b.paper_id;')
