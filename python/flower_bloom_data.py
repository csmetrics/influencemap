...
if __name__ == "__main__":
    ...
    data_df = gen_search_df(conn, Entity.AUTH, id_2_paper_id)

    influence_dict = generate_scores(conn, Entity_map(Entity.AUTH, [Entity.CONF, Entity.JOUR]), data_df, inc_self=True, unique=True)
